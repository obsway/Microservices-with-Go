...
// GetAggregrateRating returns the aggregated rating for a record or ErrNotFound if there are
// no ratings for it
func (g *Gateway) GetAggregrateRating(ctx context.Context, recordID model.RecordID, recordType model.RecordType) (float64, error) {
